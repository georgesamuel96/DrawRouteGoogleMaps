package com.icosol.driver.util.drawroutemap;
...
public class DrawRouteMaps {
    ...
    public DrawRouteMaps draw(LatLng origin, LatLng destination, GoogleMap googleMap, String key) {
        String url_route = FetchUrl.getUrl(origin, destination, key);
